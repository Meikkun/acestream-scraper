...
class ActivityLogService:
    ...
    def get_recent_activity(
        ...
        return self.repo.get_activity_logs(since=since, type=type, page=page, page_size=page_size)
    ...
    def log_activity(
        ...
        return self.repo.create_activity_log(type=type, message=message, details=details, user=user)
